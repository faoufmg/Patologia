                ...
                <div class="col">
                    <div class="row gy-2">
                        ...
                        <!-- <div class="col-md-12 col-lg-12 d-flex justify-content-center">
                            <a class="redirecionamento" href="../dentista/solicitar_exame.php">
                                <div class="box d-flex flex-column align-items-center">
                                    <img src="../../../public/image/icons/criar.svg" width="65px" height="65px" alt="Solicitar Exame">
                                    <p class="acoes text-center fw-bold">Solicitar Exame</p>
                                </div>
                            </a>
                        </div>

                        <div class="col-md-12 col-lg-12 d-flex justify-content-center">
                            <a class="redirecionamento" href="../dentista/visualizar_exames.php">
                                <div class="box d-flex flex-column align-items-center">
                        ...
                        <div class="col-md-12 col-lg-12 d-flex justify-content-center">
                            <a class="redirecionamento" href="../user/usuario_dentista.php">
                                <div class="box d-flex flex-column align-items-center">
