                ...
                <form action="../models/login.php" method="POST">
                    <div class="row list-box p-3">
                        ...
                        <div class="form-group mb-3 text-center">
                            ...
                            <input type="text" class="form-control" id="email_cadastro" name="email_cadastro" />
                        </div>
                    ...
                    <div>
                        <div class="esquececadastro text-center">
                            <a href="/src/pages/solicitar_cadastro.php">Não possui cadastro?</a>
                            <br>
                            <a href="/src/pages/login_aluno.php">Acesso para pesquisa</a>
                            <br>
                            <a href="senha/recuperar_senha.php">Recuperar Senha</a>
                        </div>
                    </div>
